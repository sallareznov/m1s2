...
public class MSTViewerManager {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(MSTViewerManager.class);

	public void generateDotFileFromSimpleGraph(WeightedGraph graph,
	...
	public void generateDotFileFromMST(String dotFilename, MSTFinder finder,
	...
	public void makeViewable(String dotFilename, String psFilename)
			throws IOException {
	...
	public void viewMST(String psFilename) throws IOException {
		final String command = "evince " + psFilename;
