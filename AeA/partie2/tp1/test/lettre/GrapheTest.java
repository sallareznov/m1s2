...
public class GrapheTest {
	...
	public void setUp() throws LongueursMotsDifferentesException, IOException {
		...
		final List<String> lesMots = dicoReader.read("dico4.txt");
		final String[] motsGrapheArray = lesMots.toArray(new String[lesMots.size()]);
		graphe = new Graphe(motsGrapheArray, 0, 1);
	}
