...
public class FastaFileReaderTest {
	...
	public void setUp() throws Exception {
		...
		validFastaFileExtension1 = new File(
				"donnees/valid_fasta_file_extension_1.fasta");
		validFastaFileExtension2 = new File(
				"donnees/valid_fasta_file_extension_2.fa");
		invalidFastaFileExtension = new File(
				"donnees/invalid_fasta_file_extension.fst");
		invalidFastaFileContent = new File(
				"donnees/invalid_fasta_file_content.fasta");
	...
	@Test
	public void testValidFastaFilesExtensions() throws FileNotFoundException,
			InvalidFastaFileException, NotAFastaFileException {
		testedReader
				.verifyExtension(validFastaFileExtension1.getAbsolutePath());
		testedReader
				.verifyExtension(validFastaFileExtension2.getAbsolutePath());
		return;
	}

	@Test(expected = NotAFastaFileException.class)
	public void testValidFastaFilesExtension() throws NotAFastaFileException,
			IOException {
		testedReader.verifyExtension(invalidFastaFileExtension
				.getAbsolutePath());
		return;
	}

	@Test
	public void testValidFastaFileContent() throws IOException,
			InvalidFastaFileException {
	...
	public void testInvalidFastaFileContent() throws IOException,
			InvalidFastaFileException {
		final BufferedWriter writer = new BufferedWriter(new FileWriter(
				invalidFastaFileContent));
