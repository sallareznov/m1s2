...
public abstract class Algorithm {
     ...
     */
    public abstract StrandOccurences findRepetitiveStrand(Genome genome, Strand strand);
     ...
     */
    public List<StrandOccurences> findRepetitiveStrands(Genome genome, List<Strand> strands) {
	...
	while (strandIterator.hasNext()) {
	    final StrandOccurences strandOccurences = findRepetitiveStrand(genome, strandIterator.next());
