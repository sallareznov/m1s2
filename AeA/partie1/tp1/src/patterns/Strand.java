...
public interface Strand {
    ...
    /**
     * @param size
     *            la taille du brin préfixe recherché
    ...
    /**
     * @param size
     *            la taille du brin suffixe recherché
    ...
    /**
     * @param prefix
     *            le brin teste en tant que prefix
    ...
    /**
     * @param suffix
     *            le brin teste en tant que suffixe
     ...
     * 
     * @param preAndSuffix
     *            le brin a testé si c'est un bord
