...
public class Main {
	...
	final FTPServerConfiguration serverConfiguration = ftpServer.getConfiguration();
	...
	System.out.println("--> FTP server opened on " + serverConfiguration.getAddress() + ", port " + serverConfiguration.getPort());
	...
	while (true) {
	    ...
	    final FTPRequestHandler requestHandler = new FTPRequestHandler(ftpDatabase, serverConfiguration, commandManager);
