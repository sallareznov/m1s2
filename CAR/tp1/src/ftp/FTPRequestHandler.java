...
public class FTPRequestHandler extends FTPMessageSender implements Runnable {
    ...
    public FTPRequestHandler(FTPServerConfiguration serverConfiguration, FTPCommandManager commandManager) {
	...
	_commandManager.execute(request.getCommand(), request.getArgument(), _clientConfiguration);
    }
	...
	try {
	    ...
	    System.err.println("I/O error occurs when creating the input stream or reading a line. Maybe the socket is closed, or is not connected");
	    e.printStackTrace();
	}
    }
}
