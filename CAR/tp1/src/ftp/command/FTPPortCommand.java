...
public class FTPPortCommand extends FTPMessageSender implements FTPCommand {
	...
	public void execute(String[] requestTokens,
		...
		final String[] portArguments = requestTokens[1].split(",");
		final String ipAddress = portArguments[0] + "." + portArguments[1]
				+ "." + portArguments[2] + "." + portArguments[3];
		final int port = (Integer.parseInt(portArguments[4]) * 256)
				+ Integer.parseInt(portArguments[5], 16);
