...
public class GraphClient {
	...
	private static final Logger LOGGER = LoggerFactory
			.create(GlobalClient.class);

	public void execute(String serverAddress) throws RemoteException,
		...
		// final GraphMessageSendingManager messageSendingManager = new
		// GraphMessageSendingManager();
		//
		// // Sequential data sending from the root node
		// LOGGER.info("\n**** SENDING A MESSAGE SEQUENTIALLY FROM THE ROOT NODE ****");
		// messageSendingManager
		// .setMessageSendingMethod(new
		// SequentialMessageSendingFromTheRootNode());
